...
<div class="card">
    ...
    <div class="card-body">
        <div class="table-responsive">
            <table class=" table table-bordered table-striped table-hover datatable datatable-Atlet">
                <thead>
                    <tr>
                        <th width="10">
                    ...
                    <tr>
                        ...
                        <td>
                            <select class="search" strict="true">
                                ...
                                @foreach(App\Models\Atlet::KATEGORI_SELECT as $key => $item)
...
@endcan
  ...
  let table = $('.datatable-Atlet:not(.ajaxTable)').DataTable({ buttons: dtButtons })
