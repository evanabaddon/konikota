...
<div class="card">
    ...
    <div class="card-body">
        <div class="table-responsive">
            <table class=" table table-bordered table-striped table-hover datatable datatable-caborEvents">
                <thead>
                    <tr>
                        <th width="10">
                ...
                <tbody>
                    @foreach($events as $key => $event)
                        <tr data-entry-id="{{ $event->id }}">
                            ...
                            <td>
                                @foreach($event->cabors as $key => $item)
                                    <span class="badge badge-info">{{ $item->name }}</span>
                                @endforeach
                            </td>
                            <td>
...
@endcan
  ...
  let table = $('.datatable-caborEvents:not(.ajaxTable)').DataTable({ buttons: dtButtons })
